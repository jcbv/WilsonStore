...
CREATE OR REPLACE FUNCTION fn_pventa( p_costo NUMERIC, pct_ganan NUMERIC )
RETURNS	NUMERIC
AS	
$$DECLARE
v_pventa NUMERIC(10,2);
BEGIN	v_pventa := p_costo + pct_ganan * p_costo;
		RETURN v_pventa;
END$$
LANGUAGE PLPGSQL;

CREATE OR REPLACE FUNCTION fn_poferta( p_costo NUMERIC, pct_ganan NUMERIC )
RETURNS	NUMERIC
AS	
$$DECLARE
v_poferta NUMERIC(10,2);
...
CREATE OR REPLACE FUNCTION fn_impuesto( p_subtotal NUMERIC )
RETURNS	NUMERIC
AS	
$$DECLARE
...
CREATE OR REPLACE FUNCTION fn_total( p_subtotal NUMERIC, p_impuesto NUMERIC )
RETURNS	NUMERIC
AS	
$$DECLARE
