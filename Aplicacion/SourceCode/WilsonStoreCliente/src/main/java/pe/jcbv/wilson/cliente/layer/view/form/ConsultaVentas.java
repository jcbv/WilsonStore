...
public class ConsultaVentas extends JDialog {
    ...
    public ConsultaVentas() {
        ...
        btnFechaF.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                final Locale locale = getLocale(lang);
                DatePicker dp = new DatePicker(txtFechaF, new Locale("es", "pe"));
    ...
    public void accionExportarCSVArt() {
        ...
        controller.exportarCSVArt(lista, "/home/joseluis/Escritorio/articulo.csv");
    ...
    public void accionExportarCSVCat() {
        ...
        controller.exportarCSVCat(lista, "/home/joseluis/Escritorio/categoria.csv");
        MessageWin.showInfo("ARCHIVO CSV CREADO");
    }
    ...
    public void accionExportarXLSArt() {
        ...
        controller.exportarXLSArt(lista, "/home/joseluis/Escritorio/articulo.xls");
    ...
    public void accionExportarXLSCat() {
        ...
        controller.exportarXLSCat(lista, "/home/joseluis/Escritorio/categoria.xls");
        MessageWin.showInfo("ARCHIVO XLS CREADO");
    }
